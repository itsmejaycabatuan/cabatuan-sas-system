...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2025 at 05:32 PM
...
(3, 'Unifast', 'Test Grantees (2024-2025)', 'Above 2.5', 'REPORT CARD, form132', '300000 yearly', '1500 monthly', 98, 'Availabe', '2026-05-15');
...
--
ALTER TABLE `tbl_logs`
  MODIFY `log_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=383;
