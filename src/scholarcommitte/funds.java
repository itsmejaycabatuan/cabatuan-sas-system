...
public void displayUsers() {
    try {
        ...
        String query = "SELECT " +
                       ...
                       "r.GPA, r.requirements_pass, r.annual_income, r.date_submit, " +
                       "r.status, r.status_release " +
                       "FROM tbl_records r " +
    ...
    private void initComponents() {
        ...
        jPanel2.add(refreshnav, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 240, 50));
        ...
        jLabel2.setText("APPLICATION's FUNDS");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 680, 50));
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        if (rowIndex < 0) {
            ...
            try {
                ...
                if (rs.next()) {
                    updateFunds af = new updateFunds();
                    af.setVisible(true);
                    ...
                    af.status_release.setSelectedItem(rs.getString("status_release"));
                    
                    // 🔽 Set the date_submit field
                ...
                ex.printStackTrace(); // Catch any unexpected issues
