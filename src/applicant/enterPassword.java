...
import static admin.enterPassword2.newEmail;
import static admin.enterPassword2.userID;
   ...
   private void updateEmail() {
    try {
        ...
        if (updatedRows > 0) {
            ...
            logPst.setString(2, "Applicant updated email address.");
            logPst.executeUpdate();
            logPst.close();

            // Refresh the applicant settings screen
