...
public class enterPassword1 extends javax.swing.JFrame {
  ...
  private void updateContact() {
    try {
        ...
        updatePst.setString(1, newContact); // Use the contact stored from the previous frame
        ...
        if (updatedRows > 0) {
            ...
            // Update the session contact if stored
        ...
        // ✅ Insert Log
        int adminID = userID; // Assuming userID is the admin's ID
        ...
        try (PreparedStatement pstmtLog = con.prepareStatement(logQuery)) {
            ...
            pstmtLog.setString(2, "Admin updated contact number");
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error updating contact!", "Database Error", JOptionPane.ERROR_MESSAGE);
    }
}
