 ...
 * @author user
 */
public class enterPassword2 extends javax.swing.JFrame {
 

    /**
     * Creates new form enterPassword
     */
    public enterPassword2() {
      initComponents();
    }
    ...
    try {
        ...
        if (updatedRows > 0) {
            ...
            try (PreparedStatement pstmtLog = con.prepareStatement(logQuery)) {
                ...
                pstmtLog.setString(2, "Admin updated email address");
   ...
   try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enterPassword2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enterPassword2().setVisible(true);
            }
        });
    }
